                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-lg-auto text-center">
                            ...
                            <li class="nav-item  mr-3">
                                <a class="nav-link" href="ahome.php">National MCM Applications</a>
                            </li>
							 <li class="nav-item active  mr-3">
                                <a class="nav-link" href="ahome2.php">TKM MCM Applications<span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item mr-3">
...
$q1="SELECT `uid`FROM `tmcm` WHERE `status`='1'";
        ...
        foreach ($e2 as $x2) {
            {   $t=$x2['id'];
                echo "<tr><td>$x2[name]</td><td>$x2[income]</td><td>$x2[cgpa]</td>
                   <td ><button  class='btn btn-primary'><a href='acceptscholarship2.php?m=$t' style='color:white;'>Accept</a></button></td>
                   <td ><button  class='btn btn-danger'><a href='rejectscholarship2.php?n=$t' style='color:white;'>Reject</a></button></td>
                   </tr>";}
